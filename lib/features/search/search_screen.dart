...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    super.initState();
    _searchFuture = SaavnApi.searchSongs('eminem'); // Quick Picks
  }
        ...
        children: [
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  icon: Icon(themeProvider.useGlassTheme ? CupertinoIcons.search : Icons.search,
                  ...
                  suffixIcon: _controller.text.isNotEmpty
                      ? IconButton(
                    icon: Icon(themeProvider.useGlassTheme ? CupertinoIcons.clear_circled_solid : Icons.close,
                        color: Colors.white70),
                    onPressed: () {
                      _controller.clear();
                      _onSearchChanged('');
          ...
          FutureBuilder<List<SaavnSong>>(
            ...
            builder: (context, snapshot) {
              ...
              final queuedSongs = songs.map((s) => QueuedSong(
                id: s.id,
                meta: NowPlaying(
                  title: s.name,
                  artist: s.artists,
